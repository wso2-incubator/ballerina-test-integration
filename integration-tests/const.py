...
M2_PATH = {"product-is": "is/wso2is", "product-apim": "am/wso2am",
           "product-ei": "ei/wso2ei","ballerina-lang": "ballerina/wso2ball"}
DIST_POM_PATH = {"product-is": "modules/distribution/pom.xml", "product-apim": "modules/distribution/product/pom.xml",
                 ...
                 "ballerina-lang": "distribution/zip/ballerina/pom.xml"}
...
LOG_FILE_PATHS = {"product-ballerina": [
    ...
    "tests/ballerina-integration-test/target/surefire-reports/testng.css",
    "tests/ballerina-integration-test/target/surefire-reports/testng-results.xml",
    "tests/ballerina-integration-test/target/surefire-reports/TestSuite.txt",
    "tests/ballerina-integration-test/target/surefire-reports/logs/automation.log"],
    "product-apim": [
